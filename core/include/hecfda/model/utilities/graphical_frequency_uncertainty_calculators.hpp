...
// ported from: HEC.FDA.Model/utilities/DoubleGlobalStatics.cs's RequiredExceedanceProbabilities
// field -- the ONLY member of that class this header needs (FillInputExceedanceProbabilitiesWith
// RequiredPoints() below). The rest of DoubleGlobalStatics.cs is out of scope for this task; if a
// future task needs the full class, move this constant into its own header rather than leaving it
// duplicated here. Transcribed verbatim (173 values, descending).
