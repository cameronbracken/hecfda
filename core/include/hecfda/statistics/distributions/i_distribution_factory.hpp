...
//
// Later distribution tasks add one `case` each (Triangular, LogPearsonIII, LogNormal,
// Deterministic, IHistogram, Empirical, TruncatedNormal), documenting their own params order
